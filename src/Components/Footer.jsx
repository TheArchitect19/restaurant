...
const Footer = () => {
    return (
        <footer className="footer section has-bg-image text-center"
            style={{'background-image': ('./assets/images/footer-bg.jpg')}}>
            <div className="container">
                ...
                <div className="footer-bottom">
                    ...
                    <p className="copyright">
                        &copy; 2022 Grilli. All Rights Reserved | Crafted by <a href="https://github.com/theArchitect19"
                            target="_blank" className="link">Ayush</a>
                    </p>
