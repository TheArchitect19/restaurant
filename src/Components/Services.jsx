...
const Services = () => {
    return (
        <section className="section service bg-black-10 text-center" aria-label="service" style={{ height: '500px', overflowY: 'auto' }}>
                    ...
                    <li>
                        <div className="service-card">
                            <a href="#" className="has-before hover:shine">
                                <div className="card-banner img-holder" style={{ '--width': 285, '--height': 336 }}>
